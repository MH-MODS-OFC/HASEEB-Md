...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://suhail-md-vtsf.onrender.com/) Or [`PARING CODE`](https://replit.com/@Itxxwasi/WASI-MD-3?v=1). And then `Go-to Whatapp>Three dots>Linked Devices`***
